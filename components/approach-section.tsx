...
export function ApproachSection() {
  const approaches = [
    ...
    },
    {
      ...
      description:
        "Мы анализируем ваши операционные потоки, выделяем узкие места и рутину, автоматизируем повторяющиеся задачи и подключаем ИИ-решения. Ваша команда освобождает время для важных задач развития.",
    },
    {
      icon: Users,
      ...
      description:
        "Мы настраиваем коммуникации, перераспределяем зоны ответственности, устраняем размытые роли. Развиваем компетенции и внедряем цифровые инструменты для достижения лучших результатов.",
    },
  ]
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Мы не ограничиваемся внедрением ИИ-инструментов или аудитом процессов. Мы погружаемся в контекст вашего
            бизнеса, находим, где система даёт сбой, и устраняем корневые причины.
          </p>
        </div>
