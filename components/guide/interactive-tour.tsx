...
const tourSteps: TourStep[] = [
  ...
  {
    id: "navigation",
    title: "Навигация по блокам",
    description: "Платформа организована в тематические блоки: Управление бизнесом, Финансы, Кадры, ИИ-инструменты.",
    detailedInfo:
      "Левая панель содержит 6 основных блоков с группировкой модулей. Каждый блок можно сворачивать для удобства навигации.",
    target: "navigation-panel",
    icon: <BookOpen className="w-5 h-5" />,
    tips: ["Кликайте на заголовки блоков для сворачивания", "Используйте поиск для быстрого доступа к модулям"],
    category: "basics",
  },
  {
    id: "metrics",
    ...
    detailedInfo:
      "Метрики обновляются в реальном времени: выручка, активные сделки, конверсия продаж. Кликайте на карточки для редактирования.",
    target: "metrics-section",
    icon: <BarChart3 className="w-5 h-5" />,
    tips: ["Используйте кнопки +/- для быстрого изменения", "Прогресс-бары показывают достижение целей"],
    category: "basics",
  },
  {
    id: "strategy",
    title: "Стратегия и цели",
    description: "Управление OKR/KPI компании с визуализацией прогресса и AI-рекомендациями.",
    detailedInfo:
      "Создавайте цели разных уровней, отслеживайте план-факт анализ, используйте еженедельные отчеты для контроля прогресса.",
    target: "strategy-section",
    icon: <Target className="w-5 h-5" />,
    tips: ["Используйте AI-помощник для формулировки целей", "Еженедельные отчеты помогают отслеживать прогресс"],
    category: "advanced",
  },
  {
    id: "finance-edo",
    title: "Финансы и документооборот",
    description: "Комплексное управление финансами, ЭДО, продажами и правовыми вопросами.",
    detailedInfo:
      "Блок включает: управление финансами, электронный документооборот с согласованием, CRM для продаж и правовой контур.",
    target: "finance-section",
    icon: <DollarSign className="w-5 h-5" />,
    tips: ["Используйте ЭДО для безбумажного документооборота", "Правовой контур поможет отслеживать договоры"],
    category: "advanced",
  },
  {
    id: "hr-team",
    title: "Кадры и команда",
    description: "Управление персоналом, развитие команды и система ролей и прав.",
    detailedInfo:
      "HR-модуль включает управление сотрудниками, организационную структуру, цели команды, обучение и кадровые процессы.",
    target: "hr-section",
    icon: <Users className="w-5 h-5" />,
    tips: ["Используйте оргструктуру для визуализации команды", "Система ролей обеспечивает безопасность"],
    category: "advanced",
  },
  {
    id: "ai-tools",
    ...
    detailedInfo:
      "ИИ-Агент для бизнеса объединяет консультанта и стратега. Включает чат, рекомендации, анализ трендов и дорожную карту.",
    target: "ai-tools-section",
    icon: <Brain className="w-5 h-5" />,
    tips: ["Начните с консультанта для получения советов", "Используйте дорожную карту для планирования"],
    category: "advanced",
  },
  {
    id: "marketing",
    title: "Маркетинг и клиенты",
    description: "Управление маркетинговыми кампаниями, воронками и автоматизацией.",
    detailedInfo:
      "Модуль включает воронку клиентов, управление кампаниями, сегментацию аудитории, A/B-тестирование и лид-скоринг.",
    target: "marketing-section",
    icon: <TrendingUp className="w-5 h-5" />,
    tips: ["Используйте лид-скоринг для приоритизации", "A/B-тесты помогают оптимизировать конверсию"],
    category: "expert",
  },
  {
    id: "support",
    title: "Поддержка и помощь",
    description: "Чат поддержки и система уведомлений для эффективной работы.",
    detailedInfo:
      "Чат поддержки доступен в полноэкранном режиме. Система уведомлений информирует о важных событиях во всех модулях.",
    target: "support-chat",
    icon: <MessageSquare className="w-5 h-5" />,
    tips: ["Используйте полноэкранный режим для детальных вопросов", "Настройте уведомления по важности"],
    category: "basics",
  },
  {
    id: "completion",
    title: "Готово! Начинайте работу",
    description: "Теперь вы знаете все возможности платформы. Создайте первый проект или настройте команду.",
    detailedInfo:
      "Рекомендуем начать с настройки целей в стратегии, добавления сотрудников в HR и активации ИИ-инструментов.",
    target: "dashboard-header",
    icon: <Award className="w-5 h-5" />,
    tips: ["Используйте ИИ-Агента для консультаций", "Изучайте аналитику для принятия решений"],
    category: "basics",
  },
]
